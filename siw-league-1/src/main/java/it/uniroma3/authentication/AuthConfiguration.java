...
//public  class WebSecurityConfig {
	...
	public static final String DEFAULT_ROLE = "OCASIONAL";
    ...
    protected SecurityFilterChain configure(final HttpSecurity httpSecurity) throws Exception{
        httpSecurity
                ...
                .requestMatchers(HttpMethod.GET,"/","/index","/register","/css/**", "/images/**","/jugadores/**", "/presidentes/**","/tecnicos/**", "/entrenadores/**").permitAll()
